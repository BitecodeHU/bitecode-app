...
<head>
    ...
    <title>Bitecode</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('img/B-black.webp') }}" type="image/x-icon">
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                ...
                <a href="{{ route('lang', 'en') }} "
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">en
                </a>
                <a href="{{ route('lang', 'hu') }} "
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">hu
                </a>
            </div>
        @endif
